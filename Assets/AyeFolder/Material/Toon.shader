	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction ( VertexInput v  )
			{
				...
				float3 normalizeResult38 = normalize( v.ase_normal );
				float4 transform14 = mul(GetObjectToWorldMatrix(),float4( ( _Thickness * normalizeResult38 ) , 0.0 ));
...
/*ASEBEGIN
Version=18912
488;425;1041;574;758.7906;535.21;1.663784;True;False
Node;AmplifyShaderEditor.NormalVertexDataNode;8;-407.6938,-113.2304;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.NormalizeNode;38;-180.6352,-71.18008;Inherit;False;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.RangedFloatNode;10;-256.5221,-280.6713;Inherit;False;Property;_Thickness;Thickness;0;0;Create;True;0;0;0;False;0;False;0.1;0.04;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;13;113.5136,-111.3421;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.UnityObjToClipPosHlpNode;39;276.7351,86.95534;Inherit;False;1;0;FLOAT3;0,0,0;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=2979665587BC36F3253AF120D190B79AC39757C7